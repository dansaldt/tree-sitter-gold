...
enum {
  ...
  anon_sym_RPAREN = 8,
  sym_source_file = 9,
  sym__type_identifier = 10,
  sym_declaration_statement = 11,
  sym_use_declaration = 12,
  sym_type_declaration = 13,
  sym_enum_item = 14,
  sym_enum_definition = 15,
  sym_enum_variant = 16,
  aux_sym_source_file_repeat1 = 17,
  aux_sym_use_declaration_repeat1 = 18,
  aux_sym_enum_definition_repeat1 = 19,
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [13] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(27),
  [16] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(26),
  [19] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 3, .production_id = 1),
  [21] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_use_declaration, 2),
  [23] = {.entry = {.count = 1, .reusable = true}}, SHIFT(9),
  [25] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_use_declaration_repeat1, 2),
  [27] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_use_declaration_repeat1, 2), SHIFT_REPEAT(28),
  [30] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_use_declaration, 4),
  [32] = {.entry = {.count = 1, .reusable = false}}, SHIFT(11),
  [34] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_use_declaration, 4),
  [36] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_use_declaration, 3),
  [38] = {.entry = {.count = 1, .reusable = true}}, SHIFT(7),
  [40] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_use_declaration, 3),
  ...
  [52] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_enum_item, 4),
  [54] = {.entry = {.count = 1, .reusable = true}}, SHIFT(10),
  [56] = {.entry = {.count = 1, .reusable = true}}, SHIFT(18),
  [58] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_enum_definition, 3),
  [60] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_declaration, 1),
  [62] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_enum_definition, 4),
  [64] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_enum_definition_repeat1, 2), SHIFT_REPEAT(23),
  [67] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_enum_definition_repeat1, 2),
  [69] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_enum_definition, 5),
  ...
  [81] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_enum_variant, 1),
