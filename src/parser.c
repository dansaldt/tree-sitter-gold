...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [2] = {
    ...
    [sym_function_modifiers] = STATE(13),
    [sym_function_forward_declaration] = STATE(43),
    [sym_function_definition] = STATE(43),
    [sym_function_external] = STATE(43),
    ...
    [sym_declaration_statement] = STATE(56),
    [sym_visibility_modifiers] = STATE(8),
    [sym_enum_item] = STATE(26),
    [aux_sym_function_modifiers_repeat1] = STATE(25),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [31] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_use_declaration_repeat1, 2),
  [33] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_use_declaration_repeat1, 2), SHIFT_REPEAT(75),
  [36] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_use_declaration_repeat1, 2),
  [38] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 3, .production_id = 1),
  ...
  [48] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(73),
  [51] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(94),
  [54] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(94),
  [57] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(79),
  [60] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_function_body_statements_repeat1, 2), SHIFT_REPEAT(71),
  [63] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_function_body_statements_repeat1, 2),
  [65] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_function_body_statements_repeat1, 2),
  [67] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_function_body_statements_repeat1, 2), SHIFT_REPEAT(85),
  [70] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_function_body_statements_repeat1, 2), SHIFT_REPEAT(79),
  [73] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 2, .production_id = 1),
  [75] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_parameters, 3),
  [77] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_parameters, 3),
  [79] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_parameters, 4),
  [81] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_parameters, 4),
  [83] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_parameters, 5),
  [85] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_parameters, 5),
  ...
  [95] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_modifiers, 1),
  [97] = {.entry = {.count = 1, .reusable = true}}, SHIFT(28),
  [99] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_modifiers, 1),
  [101] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_declaration, 1),
  [103] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_type_declaration, 1),
  [105] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_enum_definition, 3),
  [107] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_enum_definition, 3),
  [109] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_function_modifiers_repeat1, 2),
  [111] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_function_modifiers_repeat1, 2), SHIFT_REPEAT(28),
  [114] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_function_modifiers_repeat1, 2),
  [116] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_enum_item, 4),
  [118] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_enum_item, 4),
  [120] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_enum_definition, 4),
  [122] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_enum_definition, 4),
  [124] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_enum_definition, 5),
  [126] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_enum_definition, 5),
  ...
  [132] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_use_declaration, 3),
  [134] = {.entry = {.count = 1, .reusable = true}}, SHIFT(36),
  [136] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_use_declaration, 3),
  [138] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_use_declaration, 2),
  [140] = {.entry = {.count = 1, .reusable = true}}, SHIFT(35),
  [142] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_use_declaration, 2),
  [144] = {.entry = {.count = 1, .reusable = false}}, SHIFT(9),
  [146] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_use_declaration, 4),
  [148] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_use_declaration, 4),
  [150] = {.entry = {.count = 1, .reusable = true}}, SHIFT(40),
  [152] = {.entry = {.count = 1, .reusable = true}}, SHIFT(37),
  [154] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_declaration, 6, .production_id = 1),
  [156] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_declaration, 6, .production_id = 1),
  [158] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_declaration, 5, .production_id = 1),
  [160] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_declaration, 5, .production_id = 1),
  [162] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_declaration, 3, .production_id = 1),
  [164] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_declaration, 3, .production_id = 1),
  ...
  [172] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_definition, 1),
  [174] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_definition, 1),
  [176] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_declaration, 4, .production_id = 1),
  [178] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_declaration, 4, .production_id = 1),
  [180] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_declaration, 7, .production_id = 1),
  [182] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_declaration, 7, .production_id = 1),
  [184] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_forward_declaration, 1),
  [186] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_forward_declaration, 1),
  [188] = {.entry = {.count = 1, .reusable = true}}, SHIFT(21),
  [190] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_definition, 2),
  [192] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_definition, 2),
  [194] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_external, 6, .production_id = 5),
  [196] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_external, 6, .production_id = 5),
  [198] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_module_item_declaration, 1),
  [200] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_module_item_declaration, 1),
  [202] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration_statement, 1),
  [204] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_declaration_statement, 1),
  [206] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statement, 1),
  [208] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_statement, 1),
  [210] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable_declaration, 4, .production_id = 4),
  [212] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_variable_declaration, 4, .production_id = 4),
  [214] = {.entry = {.count = 1, .reusable = true}}, SHIFT(9),
  [216] = {.entry = {.count = 1, .reusable = true}}, SHIFT(31),
  [218] = {.entry = {.count = 1, .reusable = true}}, SHIFT(30),
  [220] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_function_parameters_repeat1, 2), SHIFT_REPEAT(55),
  [223] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_function_parameters_repeat1, 2),
  [225] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_enum_definition_repeat1, 2), SHIFT_REPEAT(61),
  [228] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_enum_definition_repeat1, 2),
  ...
  [248] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_parameter_declaration, 3, .production_id = 3),
  [250] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_enum_variant, 1),
  [252] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_parameter_declaration, 4, .production_id = 4),
  ...
  [278] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_parameter_modifiers, 1),
